...
class HomeViewActivity : Activity(), HomeView {
    ...
    override fun navigateToOtherDetails(artistName: String) {
        val intent = Intent(this, ayds.songinfo.moredetails.fulllogic.presentation.MoreDetailsActivity::class.java)
        intent.putExtra(ayds.songinfo.moredetails.fulllogic.presentation.MoreDetailsActivity.ARTIST_NAME_EXTRA, artistName)
