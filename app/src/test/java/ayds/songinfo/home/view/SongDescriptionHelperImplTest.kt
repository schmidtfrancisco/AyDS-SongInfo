...
class SongDescriptionHelperImplTest {

    private val releaseDateHelperFactory: ReleaseDateHelperFactory = mockk {
        every { getReleaseDateHelper(any()) } returns mockk {
            every { getSongReleaseDate() } returns "1992"
        }
    }
    private val songDescriptionHelper = SongDescriptionHelperImpl(releaseDateHelperFactory)
